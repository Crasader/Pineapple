...
const string LevelSelectController::LEVEL_FILES[NUM_LEVELS] = {LEVEL_ONE_FILE, LEVEL_TWO_FILE, LEVEL_THREE_FILE,
    ...
    LEVEL_FOURTEEN_FILE, LEVEL_FIFTEEN_FILE, LEVEL_SIXTEEN_FILE, LEVEL_SEVENTEEN_FILE, LEVEL_EIGHTEEN_FILE,
    LEVEL_NINTEEN_FILE, LEVEL_TWENTY_FILE, LEVEL_TWENTYONE_FILE, LEVEL_TWENTYTWO_FILE,
    LEVEL_TWENTYTHREE_FILE, LEVEL_TWENTYFOUR_FILE, LEVEL_TWENTYFIVE_FILE, LEVEL_TWENTYSIX_FILE,
    LEVEL_TWENTYSEVEN_FILE, LEVEL_TWENTYEIGHT_FILE, LEVEL_TWENTYNINE_FILE, LEVEL_THIRTY_FILE};
const string LevelSelectController::LEVEL_KEYS[NUM_LEVELS] = {LEVEL_ONE_KEY, LEVEL_TWO_KEY, LEVEL_THREE_KEY,
    ...
    LEVEL_FOURTEEN_KEY, LEVEL_FIFTEEN_KEY, LEVEL_SIXTEEN_KEY, LEVEL_SEVENTEEN_KEY, LEVEL_EIGHTEEN_KEY,
    LEVEL_NINTEEN_KEY, LEVEL_TWENTY_KEY, LEVEL_TWENTYONE_KEY, LEVEL_TWENTYTWO_KEY, LEVEL_TWENTYTHREE_KEY,
    LEVEL_TWENTYFOUR_KEY, LEVEL_TWENTYFIVE_KEY, LEVEL_TWENTYSIX_KEY, LEVEL_TWENTYSEVEN_KEY,
    LEVEL_TWENTYEIGHT_KEY, LEVEL_TWENTYNINE_KEY, LEVEL_THIRTY_KEY};
